...
const FooterTop = () => {
  return (
    <Container>
        <div className='bg-[linear-gradient(90deg,rgba(244,244,244,1)29%,rgba(217,217,217,1)43%)] py-[114px] px-[100px] rounded-[25px]'>
            ...
            <br/>
            <Button text="Subscribe"  paddingY="16px" paddingX="40px"/>
        </div>
    </Container>
